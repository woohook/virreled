...
fprintf(ofs,"data/gblock3.geo data/gblock3.col data/noref.ref data/gblock3.cld\r\n");
fprintf(ofs,"data/gblock4.geo data/gblock4.col data/noref.ref data/gblock4.cld\r\n");
