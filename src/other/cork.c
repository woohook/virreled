...
if(!(fis=fopen("cork.geo","w"))){printf("Could not open file\r\n");exit(1);}
...
if(!(fis=fopen("cork.ref","w"))){printf("Could not open file\r\n");exit(1);}

fprintf(fis,"%d\r\n",n);

for(i=1;i<=n;i++){
  s=sin(tt*(i-0.5)); c=cos(tt*(i-0.5));
  x0=r-rb*c; y0=d*(i-0.5)-w/2; z0=rb*s;
...
if(!(fis=fopen("cork.cld","w"))){printf("Could not open file\r\n");exit(1);}
...
if(!(fis=fopen("cork.col","w"))){printf("Could not open file\r\n");exit(1);}
...
for(i=1;i<=n;i++){
  ...
  fprintf(fis,"%d %d %d %d %d\r\n",(i-1)*8+1,(i-1)*8+4,90+10,110+10,130+10);
  if(i%2){
    fprintf(fis,"%d %d %d %d %d\r\n",(i-1)*8+5,(i-1)*8+6,80+rd,60+rd,60+rd);
  }else{
    fprintf(fis,"%d %d %d %d %d\r\n",(i-1)*8+5,(i-1)*8+6,80+rd,60+rd,60+rd);
  }
  fprintf(fis,"%d %d %d %d %d\r\n",(i-1)*8+7,(i-1)*8+8,90+10,110+10,130+10);
}
