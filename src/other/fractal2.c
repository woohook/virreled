...
fprintf(fis,"f %d %d %d\r\n",n1*n1+1,n1*n1+4,n1*n1+12);
fprintf(fis,"f %d %d %d\r\n",n1*n1+1,n1*n1+9,n1*n1+12);
fprintf(fis,"f %d %d %d\r\n",n1*n1+2,n1*n1+3,n1*n1+11);
fprintf(fis,"f %d %d %d\r\n",n1*n1+2,n1*n1+10,n1*n1+11);
fprintf(fis,"f %d %d %d\r\n",n1*n1+1,n1*n1+4,n1*n1+8);
fprintf(fis,"f %d %d %d\r\n",n1*n1+1,n1*n1+5,n1*n1+8);
fprintf(fis,"f %d %d %d\r\n",n1*n1+2,n1*n1+3,n1*n1+7);
fprintf(fis,"f %d %d %d\r\n",n1*n1+2,n1*n1+6,n1*n1+7);
...
fprintf(fis,"%d %d 34 149 27\r\n",2*n*n+1,2*n*n+4);
fprintf(fis,"%d %d 10 90 60\r\n",2*n*n+5,2*n*n+8);
